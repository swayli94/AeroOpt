...
from AeroOpt.core import MultiProcessEvaluation, SettingsData, SettingsOptimization, SettingsProblem
...
def plot_subplot(ax, opt: OptNSGAII, title: str, vmax_gen: int, show_pareto_label: bool) -> None:
    cmap = plt.cm.viridis
...
def main() -> None:
    ...
    for i, (ax, (bname, bfn)) in enumerate(zip(axes, BENCHMARKS)):
        ...
        opt = run_one_benchmark(bname, bfn, subdir, mp_eval)
